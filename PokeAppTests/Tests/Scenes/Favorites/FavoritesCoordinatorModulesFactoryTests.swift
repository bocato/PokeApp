//
//  FavoritesCoordinatorModulesFactoryTests.swift
//  PokeAppTests
//
...
class FavoritesCoordinatorModulesFactoryTests: XCTestCase {

    // MARK: - Properties
    var sut: FavoritesCoordinatorModulesFactory!
    
    // MARK: - Lifecycle
    override func setUp() {
        super.setUp()
        sut = FavoritesCoordinatorModulesFactory()
    }
